 ...
 */
object HotTopicsMapper {

    fun map(inputString: String): List<Bindable<ForumThreadSimple>> {
    ...
    fun mapFeatured(inputString: String): List<Bindable<ForumThreadSimple>> {
        val document: Document = Jsoup.parse(inputString)
        val result = mutableListOf<Bindable<ForumThreadSimple>>()
        ...
        threadsElems.forEach {
            val topicId = SanitizerMapper.getThreadIdFromLink(it)
    ...
    fun mapFeaturedWithPreview(inputString: String): List<Bindable<ForumThreadSimple>> {
        val document: Document = Jsoup.parse(inputString)
        val result = mutableListOf<Bindable<ForumThreadSimple>>()
