 ...
 */
class ForumFeaturedTopicsFragment : BaseFragment<ForumFeaturedTopicsPresenter, ForumFeaturedTopicsMvpView>(), ForumFeaturedTopicsMvpView {
    ...
    override fun getMenuItemId(): Int = R.id.navigation_featured
    ...
    override fun updateToolbar() {
        toolbarTitle = getString(R.string.toolbar_featured)
        disableHomeAsUp()
    }
